...
<?php } ?>
  ...
  <form name="frmEditDetail" method="post" action="<?php echo get_option('siteurl'); ?>/wp-content/plugins/mm-forms/includes/edit_details.php">
...
<script type="text/javascript" src="<?php echo get_option('siteurl'); ?>/wp-content/plugins/mm-forms/js/TextAreaResize.js"></script>
<link rel="scriptsheet" type="text/javascript" href="<?php echo get_option('siteurl'); ?>/wp-content/plugins/mm-forms/js/TextAreaResize.js#TextAreaResizer" title="default">
					...
					<?php 
								if($_REQUEST['t']=='edit'){									
									...
									if(eregi("uploaded-file-", $field->form_key)) {
										...
										$filePath = ABSPATH . PLUGINDIR . "/mm-forms/upload/form-upload/";
										...
										echo "<a href='".get_option('siteurl')."/wp-content/plugins/mm-forms/upload/form-upload/".$field->value."'><img src='". $thumbnail. "' /><br>" . $name ."</a>";
									} else	{
