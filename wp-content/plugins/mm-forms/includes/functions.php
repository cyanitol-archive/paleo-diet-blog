...
function showsUserOptionsDrop($currentuser)
{
   ...
   return $string; //return get_option('home') . "/" . PLUGINDIR . '/mm-forms/exports/' . $file_name ;
}
...
function createThumb($src,$height,$width,$siteurl) {
	...
	$dir = $path;
	$urlpath = str_replace($dir, $siteurl . '/wp-content/plugins/mm-forms/upload/form-upload', $path);
