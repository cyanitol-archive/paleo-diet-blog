...
<form method="post" name="frm_emails" id="frm_emails" action="<?php echo $base_url.'?page=mm-forms/mm-forms.php&action=deleteselection&form_id=' . $get_id ; ?>">
		...
		foreach($obj_actions->emails as $mail)
		{
			...
			?>
				<tr class="<?php echo $class ?>">
					...
					<?php } ?>
					<th style="font-weight:normal;" scope="col"><a href="<?php echo $base_url . '?page=' . $page . '&action=viewDetail&t=edit&id=' . $mail->id . '&form_id=' . $get_id ?>"><img src="../wp-content/plugins/mm-forms/images/pencil.png"/></a></th>
